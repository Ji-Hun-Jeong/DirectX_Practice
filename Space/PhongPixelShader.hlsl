...
Texture2D g_metalTexture : register(t5);
...
float4 main(PSInput input) : SV_TARGET
{
    ...
    float3 specular = g_specularTexture.SampleLevel(g_sampler, Input.normal, 0);
    float3 diffuse = g_irradianceTexture.SampleLevel(g_sampler, Input.normal, 0);
